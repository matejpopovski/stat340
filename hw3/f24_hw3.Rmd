...
# (2*a*sd1^2 + 2000*cov - 2*cov*a - 2*sd2^2*(1000-a) = 0
 
# (2*a*sd1^2 + 2000*cov - 2*cov*a - 2000*sd2^2 + 2*sd2^2 * a) = 0
  
# a * (2*sd1^2 - 2*cov + 2*sd2^2) = - 2000*cov + 2000*sd2^2

a = (- 2000*cov + 2000*sd2^2) / (2*sd1^2 - 2*cov + 2*sd2^2)
...
> P(R=T | F=T) = P(F=T | R=T)P(R=T) / P(F=T)

```{r}
bias = 0.93 * 115/365 / forcast_correctness
bias
```
