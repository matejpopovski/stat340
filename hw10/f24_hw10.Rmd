...
> In our case adjusted R-squared = 0.8171 suggests that predictors hp and qsec do not contribute to explanation of variance. The adjusted R-squared penalizes the inclusion of unnecessary variables.
