...
CI for predictor wt do not include zero and are negative. This means that wt is (also seen by p-value) significantly associated with mpg, and the relationship is negative. As weight increases, mpg decreases.
