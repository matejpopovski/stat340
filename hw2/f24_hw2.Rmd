...
> Another example is: get a heads after flipping a coin, and getting tails after flipping a coin. Explanation: when flipping a coin, there is only one outcome between heads or tails, so both events can never happen at the same time.
